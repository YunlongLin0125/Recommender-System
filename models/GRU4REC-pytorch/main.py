...
parser.add_argument('--n_epochs', default=100, type=int)  # number of epochs (10 in literature)
parser.add_argument('--k_eval', default=10, type=int)  # value of K durig Recall and MRR Evaluation
...
parser.add_argument('--data_folder', default='data/processed/', type=str)
parser.add_argument('--train_data', default='ml-1m_train_tr.txt', type=str)
# ml-1m_train_tr.txt
# ml-1m_train_valid.txt
