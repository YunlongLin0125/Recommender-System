...
# ------------------------------------------------normal_sasrec
python main.py --dataset=processed/ml-20m --maxlen=200 --dropout_rate=0.2 --device=cuda --window_eval=true --eval_epoch=10 --num_epochs=1000  --lr=0.001 --loss_function=sampled_softmax --log_dir=F_experiments/T/ml-20m/transfer/sampled_softmax/lr=0.001/normal_sasrec/1 --temporal=true --model=normal_sasrec --k_fold=1 --frozen_item=true --load_emb=true
